        ...
        <header className="w-full py-6 px-10 flex justify-between items-center bg-gray-900 bg-opacity-80 backdrop-blur-lg shadow-lg relative z-10">
            ...
            {menuOpen && (
                <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="absolute top-full left-0 w-full bg-gray-900 bg-opacity-95 backdrop-blur-md text-center py-6 flex flex-col gap-6 text-lg text-blue-300 md:hidden z-10"
                >
